class BranchPath < ApplicationRecord
  ARCHES = %w(i586 x86_64 aarch64 mipsel armh riscv64 ppc64le e2kv3 e2kv4 src noarch)
  PHYS_ARCHES = %w(i586 x86_64 aarch64 mipsel armh riscv64 ppc64le e2kv3 e2kv4)
