...
describe Package::Built do
   ...
   context 'Associations' do
      ...
      xit { is_expected.to have_many(:provides).dependent(:destroy) }
      xit { is_expected.to have_many(:requires).dependent(:destroy) }
      xit { is_expected.to have_many(:obsoletes).dependent(:destroy) }
      xit { is_expected.to have_many(:conflicts).dependent(:destroy) }
   end
